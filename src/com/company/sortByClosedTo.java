...
public class sortByClosedTo {
    ...
    public static String sortByClosest(String[] toBeSorted, String sortingBy){
        ...
        for (int i = 0; i < toBeSorted.length; i++) {
            //split a single String in toBeSorted into separate characters
            ...
            //if there are more similar characters in the latest String then override the output and outputInt
            if (count>outputInt){
                outputInt=count;
                output=toBeSorted[i];
            }
